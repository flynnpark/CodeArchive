"""
Django settings for codearchive project.
...
SECRET_KEY = '=9a9vcwxvntdv0mt5(4dnk(!+kgxz=x70+*8b=-n^h^beb*rjh'
...
WSGI_APPLICATION = 'codearchive.wsgi.application'
